...
**Review debt (generated from [AUDIT](./AUDIT.md)):** 0 of 3 stories `done` since the last backlog review (2026-09-13, verdict `amended`). A drift event makes a review due regardless of this count.
