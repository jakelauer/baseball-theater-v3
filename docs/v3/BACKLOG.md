...
**Review debt (generated from [AUDIT](./AUDIT.md)):** 2 of 3 stories `done` since the last backlog review (2026-09-14, verdict `amended`): S27, S25. A drift event makes a review due regardless of this count.
