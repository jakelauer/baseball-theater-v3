import type {
	CadenceParams, GameSnapshot, ScheduleDay,
} from "@bt/domain";
import {
	DEFAULT_CADENCE, isGameInActiveWindow, projectGame,
} from "@bt/domain";
import type {
...
import { isStale } from "./refresh.js";
...
function needsRefresh(
	entity: { fetchedAt?: string;
		windowMode?: "active" | "cache" } | null,
	now: Date,
	force: boolean,
): boolean
{
